...
import { type ApiAuth, type DashPass, Store } from "./store/db";
...
/** One wrapper for all three /v1 POST surfaces — only the handler and the
 *  invalid-JSON envelope differ (anthropic speaks its own error shape). */
