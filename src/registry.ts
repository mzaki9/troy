...
export const PROVIDERS: Provider[] = [
  ...
  { id: "cohere", aliases: ["cohere"], baseUrl: "https://api.cohere.ai/v1/chat/completions", auth: "bearer" },
  ...
  { id: "nebius", aliases: ["nebius"], baseUrl: "https://api.studio.nebius.ai/v1/chat/completions", auth: "bearer" },
  ...
  { id: "opencode", aliases: ["oc", "opencode"], baseUrl: "https://opencode.ai/zen/go/v1/chat/completions", auth: "none" },
  { id: "opencode-go", aliases: ["ocg", "opencode-go"], baseUrl: "https://opencode.ai/zen/go/v1/chat/completions", auth: "bearer" },
  { id: "glm", aliases: ["glm", "zai"], baseUrl: "https://api.z.ai/api/coding/paas/v4/chat/completions", auth: "bearer" },
  { id: "glm-cn", aliases: ["glm-cn"], baseUrl: "https://open.bigmodel.cn/api/coding/paas/v4/chat/completions", auth: "bearer" },
  ...
  { id: "alicode", aliases: ["alicode"], baseUrl: "https://coding.dashscope.aliyuncs.com/v1/chat/completions", auth: "bearer" },
  { id: "alicode-intl", aliases: ["alicode-intl"], baseUrl: "https://coding-intl.dashscope.aliyuncs.com/v1/chat/completions", auth: "bearer" },
  { id: "alims-intl", aliases: ["alims-intl"], baseUrl: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1/chat/completions", auth: "bearer" },
  { id: "byteplus", aliases: ["byteplus", "bpm"], baseUrl: "https://ark.ap-southeast.bytepluses.com/api/coding/v3/chat/completions", auth: "bearer" },
  { id: "volcengine-ark", aliases: ["ark", "volcengine-ark"], baseUrl: "https://ark.cn-beijing.volces.com/api/coding/v3/chat/completions", auth: "bearer" },
  { id: "alitp-intl", aliases: ["alitp-intl"], baseUrl: "https://token-plan.ap-southeast-1.maas.aliyuncs.com/compatible-mode/v1/chat/completions", auth: "bearer" },
];
...
export function inferProvider(model: string): Provider {
  ...
  if (model.startsWith("glm-")) return getProvider("glm-cn")!;
