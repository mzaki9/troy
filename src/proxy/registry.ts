...
export const PROVIDERS: Provider[] = [
  ...
  {
    id: "opencode",
    aliases: ["oc", "opencode", "opencode-free", "zen"],
    baseUrl: "https://opencode.ai/zen/v1/chat/completions",
    auth: "none",
  },
  {
    id: "opencode-go",
    aliases: ["ocg", "opencode-go", "opencode-zen-go"],
  ...
  {
    id: "zai-cn",
    aliases: ["zai-cn", "glm-cn", "zhipu", "bigmodel"],
  ...
  },
  {
    ...
    auth: "bearer",
    headers: { "x-requested-with": "XMLHttpRequest", "X-Product": "gpts", "X-IDE-Type": "vscode" },
  },
  {
    id: "codebuddy-intl",
    aliases: ["cbai"],
  ...
  { id: "kilo-gateway", aliases: ["kgw"], baseUrl: "https://api.kilo.ai/api/gateway/chat/completions", auth: "bearer" },
  {
    ...
    auth: "bearer",
    placeholders: ["accountId"],
  },
  {
    id: "alicode",
    aliases: ["alicode", "qwen-code"],
    baseUrl: "https://coding.dashscope.aliyuncs.com/v1/chat/completions",
    auth: "bearer",
  },
  {
    id: "alicode-intl",
    aliases: ["alicode-intl", "qwen-code-intl"],
    baseUrl: "https://coding-intl.dashscope.aliyuncs.com/v1/chat/completions",
    auth: "bearer",
  },
  {
    id: "alibaba",
    aliases: ["alibaba", "alims-intl", "dashscope-intl"],
  ...
  {
    id: "volcengine-ark",
    aliases: ["ark", "volcengine-ark"],
    baseUrl: "https://ark.cn-beijing.volces.com/api/v3/chat/completions",
    auth: "bearer",
  },
  {
    id: "alibaba-token-plan",
    aliases: ["alibaba-token-plan", "alitp-intl", "atp"],
