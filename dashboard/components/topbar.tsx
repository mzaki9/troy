  ...
  return (
    <header className="flex items-center justify-between gap-3 border-b border-border bg-card px-8 py-4">
      <div className="flex min-w-0 items-center gap-3">
        <meta.icon className="size-4 shrink-0 text-ink" />
      ...
      <div className="flex shrink-0 items-center gap-2">
        <span className="hidden rounded-full border border-border bg-white px-3.5 py-1.5 font-mono text-xs text-muted-foreground sm:inline">
          {location.origin}/v1
        </span>
