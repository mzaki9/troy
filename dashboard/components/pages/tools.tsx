...
import { Bot, Box, ChevronDown, Code2, KeyRound, MousePointer2, RefreshCw, Sparkles } from "lucide-react";
import { useState } from "react";
import { cn } from "../../lib/utils";
import { type ApiKeyInfo, api, type LogRow, type SavedModel, useApi } from "../api";
...
export function ToolsPage() {
  ...
  const model =
    selectedModel && (chosen.length === 0 || chosen.includes(selectedModel)) ? selectedModel : fallbackModel;
